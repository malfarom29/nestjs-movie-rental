...
export class AddUserPurchaseOrderRelation1593753566279 implements MigrationInterface {
    name = 'AddUserPurchaseOrderRelation1593753566279'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "purchase_order" ADD "userId" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "purchase_order" DROP COLUMN "userId"`);
    }
